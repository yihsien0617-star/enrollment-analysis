...
st.markdown('<div class="sub-header">Enrollment Analytics v6.8 ｜ 人頭數 vs 志願次數 ｜ 全年度惡化偵測 ｜ 三段轉換率</div>', unsafe_allow_html=True)
...
ABBREV_EXPAND = {
    "寵護": "寵物照護", "寵美": "寵物美容", "寵經": "寵物經營",
    "食營": "食品營養", "環安": "環境與安全衛生工程", "環衛": "環境與安全衛生工程",
    "職安": "職業安全衛生", "資管": "資訊管理", "多媒": "多媒體設計",
    "幼保": "幼兒保育", "運休": "運動健康與休閒", "餐旅": "餐旅管理",
    "觀光": "觀光休閒事業管理", "觀休": "觀光休閒事業管理",
    "妝管": "化妝品應用與管理", "美妝": "化妝品應用與管理", "化妝": "化妝品應用與管理",
    "調保": "調理保健技術", "調理": "調理保健技術",
    "語治": "語言治療", "牙技": "牙體技術", "生科": "生物科技",
    "醫技": "醫學檢驗生物技術", "醫檢": "醫學檢驗生物技術",
    "醫管": "醫務暨健康事務管理", "健管": "醫務暨健康事務管理",
    "製藥": "製藥工程", "長照": "長期照護", "護理": "護理",
    "藥學": "藥學", "視光": "視光",
}
